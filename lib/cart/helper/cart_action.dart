...
void deleteCartProduct(CookieRequest request, String id, BuildContext context,
  ...
  final endpoint =
      "http://muhammad-rafli33-souvenirkita.pbp.cs.ui.ac.id/cart/delete_cart_product_flutter/$id/";
...
void updateAmount(CookieRequest request, String id, bool increment,
  ...
  final endpoint =
      "http://muhammad-rafli33-souvenirkita.pbp.cs.ui.ac.id/cart/${increment ? 'inc_amount' : 'dec_amount'}/$id/";
            ...
            onPressed: () async {
              ...
              try {
                final response = await request.postJson(
                  "http://muhammad-rafli33-souvenirkita.pbp.cs.ui.ac.id/cart/update_note/$cartProductId/",
